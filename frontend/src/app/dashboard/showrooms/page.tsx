      ...
      <div className="space-y-5">
        ...
        <Modal open={addOpen} onClose={() => setAddOpen(false)} title="إنشاء معرض جديد" size="md"
          ...
          <div className="space-y-4">
            {[{ k: 'name', l: 'اسم المعرض *', p: 'معرض النجمة', ltr: false }, { k: 'slug', l: 'Slug *', p: 'alnajma', ltr: true }, { k: 'phone', l: 'الهاتف (اختياري)', p: '+967...', ltr: true }, { k: 'email', l: 'البريد (اختياري)', p: 'info@showroom.com', ltr: true }, { k: 'address', l: 'العنوان (اختياري)', p: 'صنعاء', ltr: false }].map(({ k, l, p, ltr }) => (
